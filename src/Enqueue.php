...
class Enqueue {
	...
	public static function load_styles() {
		...
		if ( ( is_a( $post, 'WP_Post' ) && has_shortcode( $post->post_content, 'coolkids_login' ) ) ||
			...
			";
			wp_add_inline_style( CKN_SLUG . '-style', $form_style );
		}//end if

		if ( is_a( $post, 'WP_Post' ) && has_shortcode( $post->post_content, 'coolkids_signup' ) ) {
			$form_style = '
		...
		if ( is_a( $post, 'WP_Post' ) && has_shortcode( $post->post_content, 'coolkids_home' ) ) {
			...
			';
			wp_add_inline_style( CKN_SLUG . '-style', $home_style );
		}//end if
	}
